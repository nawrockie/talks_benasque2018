...
\center{\includegraphics[width=8in]{figs/gissd-banner}}

\center{\includegraphics[width=8in]{figs/GISSD-stats-zoomed}}
...
\center{\includegraphics[height=8in]{figs/benasque-acknowledgements}}
